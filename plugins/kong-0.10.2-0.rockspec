...
build = {
  ...
  modules = {
    ...
    ["kong.plugins.key-auth-redis.api"] = "kong/plugins/key-auth-redis/api.lua",
    ["kong.plugins.key-auth-redis.schema"] = "kong/plugins/key-auth-redis/schema.lua",
    ["kong.plugins.key-auth-redis.daos"] = "kong/plugins/key-auth-redis/daos.lua",
    ["kong.plugins.key-auth-redis.hooks"] = "kong/plugins/key-auth-redis/hooks.lua",
    ["kong.plugins.key-auth-redis.migrations.cassandra"] = "kong/plugins/key-auth-redis/migrations/cassandra.lua",
    ["kong.plugins.key-auth-redis.migrations.postgres"] = "kong/plugins/key-auth-redis/migrations/postgres.lua",

    ["kong.plugins.general-limiting.handler"] = "kong/plugins/general-limiting/handler.lua",
    ["kong.plugins.general-limiting.schema"] = "kong/plugins/general-limiting/schema.lua",
  }
}
